...
function ProductCard({ source, name, price, alt, isActive, id }: TProduct) {
  ...
  return (
    <div className="flex h-full flex-col items-center text-white">
      ...
      <div
        className={cn(
          'absolute -bottom-0 !z-[99] w-fit translate-y-full items-center justify-between rounded-full bg-white/35 p-3 opacity-0 transition-opacity duration-[1000ms] md:w-[360px] lg:flex',
